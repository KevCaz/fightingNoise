...
#### $$\text{Biotracers} \sim \mathcal{N}(\mu, \Sigma)$$
...
---
# Results - dimensionality (up to 10)
...
#### - Regual relatioship sample ![:faic](arrow-right) isosca pe
