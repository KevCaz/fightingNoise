...
####  ![:faic](angle-double-right ) Why should we combine multiple sourcse of information in this context?
...
#### One distribution per area*biotracer
...
### &nbsp;&nbsp; O<sub>1</sub>|S<sub>n</sub>?  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; S<sub>n</sub>|O<sub>i</sub> known!
...
- S<sub>n</sub>: Sample of size n
- O<sub>1</sub>|S<sub>n</sub>?
- S<sub>n</sub>|O<sub>i</sub> Likelihood
...
- Bayesian Inversion rule:

![:scalec](img/Bayes.png)

<!-- $$[O_1|S_{n}] = \frac{[S_{n}|O_i][O_i]}{\sum_j [S_{n}|O_j][O_j]}$$ -->
...
.center[![:scale 92%](img/FigSd1.png)]
...
.center[![:scale 92%](img/FigSd2.png)]

---
# Theory - dissimilarity
<br>

.center[![:scale 92%](img/FigSd3.png)]

---
# Theory - dissimilarity
<br>

.center[![:scale 92%](img/FigSd4.png)]
...
.center[![:scale 92%](img/FigSd5.png)]
...
.center[![:scale 92%](img/FigSd6.png)]
...
.center[![:scale 92%](img/FigSd7.png)]
...
## ![:faic](arrow-right) δ<sup>15</sup>O + δ<sup>13</sup>C

<br>

## ![:faic](arrow-right) cor(δDp, δ<sup>15</sup>O) = .99
...
#### - Regular relatioship sample ![:faic](arrow-right) isoscape

#### - No mixture

#### - Sample is from Alaska, so O<sub>1</sub>|S<sub>n</sub>?
